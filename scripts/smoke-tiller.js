...
const checks = [
  ...
  { message: "Kan jeg be om prisen på en kjøretime?", includes: ["800 kr"], forbids: ["BE og B96"] },
  { message: "Kan jeg be om en kjøretime?", includes: ["/contact", "bekrefter tidspunktet"], forbids: ["BE og B96"] },
  { message: "Kan jeg be om en kjøretime for klasse BE?", includes: ["BE og B96 er ikke oppført"], forbids: ["800 kr"] },
  { message: "Hva koster en kjøretime på 60 minutter?", includes: ["timelengden", "ikke bekreftet"], forbids: ["800 kr"], unsure: true },
  ...
  { message: "Hvor lenge varer trinnvurdering 3?", includes: ["60 minutter"], forbids: ["45 minutter"] },
